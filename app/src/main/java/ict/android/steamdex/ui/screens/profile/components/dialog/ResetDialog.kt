...
fun ResetDialog(
    ...
    ConfirmDialog(
        ...
        dialogTitle = stringResource(R.string.profile_screen_reset_dialog_title),
        dialogDescription = stringResource(R.string.profile_screen_reset_dialog_description),
