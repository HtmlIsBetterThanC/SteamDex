...
fun AppVersionDialog(
    ...
    InformationDialog(
        ...
        dialogTitle = stringResource(R.string.about_app_screen_version_dialog_title),
        dialogDescription = stringResource(R.string.about_app_screen_version_dialog_description, version),
